...
1. **Excessive hedging** — phrases like "it's important to note that", "it's worth mentioning", "of course", "certainly". These signal AI caution, not human confidence.
2. **No concrete examples** — AI produces generalities. Human writing anchors ideas to specific people, places, prices, and dates. If a paragraph could apply to any business anywhere, it needs a specific detail added.
3. **Overly smooth transitions** — "Furthermore", "Moreover", "In conclusion", "In today's fast-paced world". These are AI connective tissue. Remove them.
4. **Generic openings** — AI almost always opens with the broadest possible statement about the topic. Human writers start in the middle of the action.
5. **No local specificity** — AI does not know your neighbourhood, your customers' names, or the Kampala matatu that passes your shop. If the content could have been written for any city in any country, it has not been localised.
