...
description: >
  Step-by-step setup and daily operation of WhatsApp Business as a structured
  marketing, sales, and customer service channel for East African businesses. Invoke
  when a client needs to professionalise their WhatsApp presence — moving from ad hoc
  personal-style messaging to a branded, systematised business operation. Source:
  Pidsley (2023) Social Media Marketing for Business.
---
