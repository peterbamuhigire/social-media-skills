...
description: Produces a cross-platform social media profile audit checklist and an action-prioritised optimisation plan covering profile photos, cover images, bios, usernames, link strategy, CTAs, and platform-specific settings. Invoke this skill at client onboarding to establish a baseline, whenever a client rebrands, or when a profile audit reveals weak first-impression signals across platforms.
---
