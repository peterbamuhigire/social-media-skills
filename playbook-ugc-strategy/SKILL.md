...
description: >
  Builds a complete User-Generated Content (UGC) strategy for a client — covering audit,
  collection systems, permission management, curation filters, and publishing guidelines.
  Invoke when a client needs a structured plan to collect, curate, and republish content
  created by their customers, community members, or fans. Particularly suited to East African
  markets where peer recommendation is the dominant trust signal and brand advertising is
