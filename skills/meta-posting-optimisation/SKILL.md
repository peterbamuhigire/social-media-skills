...
description: >
  Produces a data-driven posting time and frequency optimisation plan for a client.
  Covers how to read native analytics to find peak activity windows, a structured
  4-week test design, and a frequency decision framework. Replaces generic "best time
  to post" articles with client-specific recommendations grounded in the client's own
