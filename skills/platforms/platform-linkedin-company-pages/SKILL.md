...
description: Use when creating a Linkedin Company Pages channel plan covering account setup, content, community and measurement for Uganda or East Africa. Use a playbook for cross-channel operations and a strategy skill for channel selection.
metadata:
  portable: true
  compatible_with:
  - claude-code
...
<!-- dual-compat-start -->
## Use When
- Create or revise a Linkedin Company Pages-specific presence, growth or publishing plan.
...
| Current platform rules and feature limits | Official Linkedin Company Pages help or policy source | Conditional | Omit volatile specifications or flag them for live verification |
...
## Degraded Mode
If accounts, files, network, rendering or current evidence are unavailable, return the narrowest useful qualified Linkedin Company Pages channel plan plus an evidence-gap list. Mark each unavailable check `not assessed`; never convert it into a pass.

## Decision Rules
| Condition | Action | Failure or risk avoided |
|---|---|---|
| The update needs an accountable human voice | Publish through the relevant employee and amplify from the page | Faceless company-page reach decay |
...
3. Apply the decision rules, preserve useful existing material and draft the Linkedin Company Pages channel plan.
...
|---|---|---|
| Linkedin Company Pages channel plan | Client owner and delivery team | Uses named inputs, assigns actions, states decisions and contains no unverified specifics |
