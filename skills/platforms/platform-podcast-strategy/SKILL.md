...
description: >
  Plans and launches a podcast strategy for a client in Uganda/East Africa. Covers
  show concept, format selection, minimum viable technical setup (with UGX pricing),
  a 12-episode content plan, social media integration, and EA-specific distribution
  tactics. Treats the podcast as a content and authority-building channel — not an
  audio production project. Invoke when a client asks about starting a podcast, using
  audio content for thought leadership, or building an owned media channel beyond
  written content.
---
