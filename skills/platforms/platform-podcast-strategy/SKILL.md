---
name: platform-podcast-strategy
description: Use when creating a Podcast Strategy channel plan covering account setup, content, community and measurement for Uganda or East Africa. Use a playbook for cross-channel operations and a strategy skill for channel selection.
metadata:
  portable: true
  compatible_with:
  - claude-code
...
<!-- dual-compat-start -->
## Use When
- Create or revise a Podcast Strategy-specific presence, growth or publishing plan.
...
| Current platform rules and feature limits | Official Podcast Strategy help or policy source | Conditional | Omit volatile specifications or flag them for live verification |
...
## Degraded Mode
If accounts, files, network, rendering or current evidence are unavailable, return the narrowest useful qualified Podcast Strategy channel plan plus an evidence-gap list. Mark each unavailable check `not assessed`; never convert it into a pass.

## Decision Rules
| Condition | Action | Failure or risk avoided |
|---|---|---|
| Access to credible guests is stronger than host authority | Choose an interview format with consent and release controls | A weak solo format or unusable recordings |
...
3. Apply the decision rules, preserve useful existing material and draft the Podcast Strategy channel plan.
...
|---|---|---|
| Podcast Strategy channel plan | Client owner and delivery team | Uses named inputs, assigns actions, states decisions and contains no unverified specifics |
