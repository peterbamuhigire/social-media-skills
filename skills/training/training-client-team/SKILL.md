...
| Existing channel, content, commercial, or performance evidence relevant to a two-hour operational social-media handover workshop and workbook | Client systems, supplied files, or verified research | conditional | Mark the check unassessed and avoid performance claims |
...
1. Confirm the decision, consumer, market, and evidence boundary; distinguish the request from `training-social-media-fundamentals`.
...
|---|---|---|
| A two-hour operational social-media handover workshop and workbook deliverable | Client decision-maker or delivery team | Names the chosen route, owners, sequence, assumptions, and measurable acceptance checks |
...
**[Client Name] Social Media Team Training**
Internal Workbook — Confidential
Workshop Date: [Date]
Prepared by: [SM Manager Name]
Participants: [Team Size] team members
...
Respond to: genuine questions, positive comments, requests for information, complaints (escalate these — see Module 6).
Ignore: spam accounts, offensive comments with no genuine intent, unsolicited sales messages. Do not engage with trolls.
...
1. Select one product or workspace feature in this room
2. Apply at least 3 of the tips above before shooting
3. Take 5 photos — vary the angle and framing for each
4. Select your best shot and share it with the group
5. Group discussion: what worked, what you would change
...
1. Open [app.buffer.com] on your browser or the Buffer app on your phone
2. Enter your team login credentials — these are shared by [SM Manager Name]. Do not create a personal Buffer account
3. You will see the dashboard showing all connected platforms

**Drafting and Scheduling a Post**

1. Click **New Post** (top right)
2. Select the platform(s) you are posting to — tick each one
3. Write your caption in the text box. Paste the approved caption from the submission (Module 5)
4. Click **Add photo/video** and upload your approved image or video file
5. Read the character count indicator — stay within the recommended limit for each platform
6. Click **Schedule for a specific time** and select the date and time agreed in the approval workflow
7. Click **Add to Queue** or **Schedule** — the post is now queued
...
1. Image or video file (full resolution, not a screenshot)
2. Draft caption — written out in full
3. Platform intended for (e.g. Facebook + Instagram / WhatsApp Status only)
4. Requested date and time for publishing
5. Any context [SM Manager Name] needs to know (e.g. "this was taken at today's team meeting")
...
> **Message 1 (General enquiry):**
> "Thank you for reaching out to [Business Name]. We have received your message and will be in touch shortly. For urgent assistance, please contact us on [WhatsApp number]."

> **Message 2 (Complaint):**
> "Thank you for letting us know. We take this seriously and want to make it right. A member of our team will contact you directly within [X hours]. We appreciate your patience."

> **Message 3 (Product / service question):**
> "Thank you for your interest in [Business Name]. We will connect you with the right person who can answer your question fully. Please expect to hear from us within [X hours]."
...
**Exercise 1 — Smartphone Photography (Module 3, 15 minutes)**
Each participant photographs one product or workspace feature using the tips in Module 3. Share with the group. Discuss what worked.

**Exercise 2 — Caption Writing (15 minutes)**
Using the brand voice and content pillars from Module 1, each participant writes a 3-sentence caption for the photo they took in Exercise 1. Read aloud. Group gives feedback using this prompt: *Does it sound like us? Is there a clear action?*

**Exercise 3 — Customer Complaint Scenario (10 minutes)**
Role play: a customer posts on the company Facebook page: *"I ordered from you last week and still have not received my delivery. This is unacceptable."*
In pairs: one plays the customer, one plays the team member. Apply Module 6 guidelines. Debrief as a group.
