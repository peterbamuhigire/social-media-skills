...
description: >
  Establishes shared KPI ownership, CRM discipline, and a lead handover SLA
  between marketing and sales functions. Invoke when a client has both marketing
  and sales teams and attribution disputes, low lead conversion rates, or
  siloed reporting are reducing the effectiveness of both functions. Also invoke
  when a sole-trader or micro-business owner needs to align their marketing
  activity with their own follow-up behaviour.
---
