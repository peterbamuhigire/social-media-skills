---
name: playbook-social-media-governance
description: Use when designing or improving a Social Media Governance operating playbook with roles, ordered actions, controls and measures. Use platform skills for channel plans and strategy skills for upstream direction.
metadata:
  portable: true
  compatible_with:
  - claude-code
...
<!-- dual-compat-start -->
## Use When
- Build or improve a repeatable Social Media Governance workflow for a client or delivery team.
...
## Degraded Mode
If accounts, files, network, rendering or current evidence are unavailable, return the narrowest useful qualified Social Media Governance playbook plus an evidence-gap list. Mark each unavailable check `not assessed`; never convert it into a pass.

## Decision Rules
| Condition | Action | Failure or risk avoided |
|---|---|---|
| No one owns a high-risk account or approval step | Stop rollout and assign an accountable role | Orphaned access and decisions |
...
3. Apply the decision rules, preserve useful existing material and draft the Social Media Governance playbook.
...
|---|---|---|
| Social Media Governance playbook | Client owner and delivery team | Uses named inputs, assigns actions, states decisions and contains no unverified specifics |
