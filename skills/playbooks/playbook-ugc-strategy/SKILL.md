---
name: playbook-ugc-strategy
description: Use when designing or improving a Ugc Strategy operating playbook with roles, ordered actions, controls and measures. Use platform skills for channel plans and strategy skills for upstream direction.
metadata:
  portable: true
  compatible_with:
  - claude-code
...
<!-- dual-compat-start -->
## Use When
- Build or improve a repeatable Ugc Strategy workflow for a client or delivery team.
...
## Degraded Mode
If accounts, files, network, rendering or current evidence are unavailable, return the narrowest useful qualified Ugc Strategy playbook plus an evidence-gap list. Mark each unavailable check `not assessed`; never convert it into a pass.

## Decision Rules
| Condition | Action | Failure or risk avoided |
|---|---|---|
| Consent, usage duration or compensation is unclear | Do not reuse the contribution until terms are recorded | Rights disputes and contributor exploitation |
...
3. Apply the decision rules, preserve useful existing material and draft the Ugc Strategy playbook.
...
|---|---|---|
| Ugc Strategy playbook | Client owner and delivery team | Uses named inputs, assigns actions, states decisions and contains no unverified specifics |
