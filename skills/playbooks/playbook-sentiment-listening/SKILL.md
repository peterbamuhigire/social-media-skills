...
description: Use when designing or improving a Sentiment Listening operating playbook with roles, ordered actions, controls and measures. Use platform skills for channel plans and strategy skills for upstream direction.
metadata:
  portable: true
  compatible_with:
  - claude-code
...
<!-- dual-compat-start -->
## Use When
- Build or improve a repeatable Sentiment Listening workflow for a client or delivery team.
...
## Degraded Mode
If accounts, files, network, rendering or current evidence are unavailable, return the narrowest useful qualified Sentiment Listening playbook plus an evidence-gap list. Mark each unavailable check `not assessed`; never convert it into a pass.

## Decision Rules
| Condition | Action | Failure or risk avoided |
|---|---|---|
| Automated sentiment conflicts with language or cultural context | Manually sample and relabel before reporting | False conclusions from weak classification |
...
3. Apply the decision rules, preserve useful existing material and draft the Sentiment Listening playbook.
...
|---|---|---|
| Sentiment Listening playbook | Client owner and delivery team | Uses named inputs, assigns actions, states decisions and contains no unverified specifics |
