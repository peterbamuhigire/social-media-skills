---
name: playbook-profile-optimisation
description: Use when designing or improving a Profile Optimisation operating playbook with roles, ordered actions, controls and measures. Use platform skills for channel plans and strategy skills for upstream direction.
metadata:
  portable: true
  compatible_with:
  - claude-code
...
<!-- dual-compat-start -->
## Use When
- Build or improve a repeatable Profile Optimisation workflow for a client or delivery team.
...
## Degraded Mode
If accounts, files, network, rendering or current evidence are unavailable, return the narrowest useful qualified Profile Optimisation playbook plus an evidence-gap list. Mark each unavailable check `not assessed`; never convert it into a pass.

## Decision Rules
| Condition | Action | Failure or risk avoided |
|---|---|---|
| A profile must serve discovery and conversion | Prioritise a clear category, proof and one next action | Decorative profile copy with no route forward |
...
3. Apply the decision rules, preserve useful existing material and draft the Profile Optimisation playbook.
...
|---|---|---|
| Profile Optimisation playbook | Client owner and delivery team | Uses named inputs, assigns actions, states decisions and contains no unverified specifics |
