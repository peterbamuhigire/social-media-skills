...
3. **Customer list details** — approximate size of the dormant list, how
   old the records are, format (email addresses, WhatsApp numbers, phone
   numbers, or a combination)
4. **Time since last contact** — when did they last communicate with this
   list? (6 months / 1 year / 3+ years)
5. **Reason for dormancy** — did the business stop emailing, or did
   customers stop responding?
6. **Best-performing product or service** — the one offer customers loved
   most; this becomes the reactivation hook
7. **Current offer or incentive** — is there a discount, bonus, or
   exclusive perk available for returning customers? (If not, the skill
   will suggest one)
8. **Preferred delivery channel** — email only / WhatsApp only / email +
   WhatsApp combined / SMS
9. **Brand voice** — formal, warm, casual; any specific phrases or
