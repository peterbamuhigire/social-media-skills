---
name: strategy-micro-communities
description: Use when the main deliverable concerns niche WhatsApp, Facebook, LinkedIn, or private communities built around member value; use playbook-community-management when that neighbouring workflow owns the primary decision.
metadata:
  portable: true
  compatible_with:
  - claude-code
...
- Use this skill for niche WhatsApp, Facebook, LinkedIn, or private communities built around member value.
- Use it when the requested deliverable needs the domain decisions and acceptance checks below.

## Do Not Use When

- Use `playbook-community-management` when that neighbouring workflow owns the main decision or deliverable.
...
| Existing channel, content, commercial, or performance evidence relevant to niche WhatsApp, Facebook, LinkedIn, or private communities built around member value | Client systems, supplied files, or verified research | conditional | Mark the check unassessed and avoid performance claims |
...
1. Confirm the decision, consumer, market, and evidence boundary; distinguish the request from `playbook-community-management`.
...
|---|---|---|
| Niche whatsapp, facebook, linkedin, or private communities built around member value deliverable | Client decision-maker or delivery team | Names the chosen route, owners, sequence, assumptions, and measurable acceptance checks |
...
|---|---|---|
| A specific member need and operating capacity exist | Define membership promise, moderation, and cadence before recruitment | An unmanaged broadcast group creates spam and trust loss |
...
1. **Client business name and industry** — e.g., "Kampala Bakers Ltd — food and beverage"
2. **Country/city** — default Uganda/East Africa if not specified
3. **Primary audience** — who would join this community, and why would they join? Be specific about demographics, shared interests, and motivations
4. **Business objective** — what should the community achieve? (customer retention, lead generation, product feedback, brand advocacy, or a combination)
5. **Moderation capacity** — how many hours per week can the client or their team dedicate to moderating and posting in the community?
6. **Existing community** — does the client already have a Facebook Group, WhatsApp group, forum, or informal community? If yes, describe its current state (member count, activity level, problems)
7. **Platform preference** — Facebook Group, WhatsApp Community, LinkedIn Group, or private forum? If the client is unsure, apply the decision framework in Section 2
...
**Example:**
1. Access to other vetted business owners in the same sector who share real numbers and real challenges — not curated highlight reels
2. First access to the client's new product launches, promotions, and free resources before the public
3. Monthly Q&A sessions with the brand founder or invited expert, exclusive to community members
...
1. Introduce yourself when you join — tell us who you are and what brought you here
2. Share your knowledge and experience freely — this is a giving community, not a selling community
3. No spam, unsolicited promotion, or advertising without prior admin approval
4. Treat every member with respect — no harassment, personal attacks, discrimination based on gender, religion, ethnicity, or any other characteristic
5. Do not share false or unverified claims, particularly regarding health, finance, or legal matters
6. Tag the admin if you see a post that violates these rules
7. **Consequences:** first offence → admin warning via private message; second offence → post removed; third offence → permanent removal from the group
...
| Skill | When to Use |
|---|---|
| `playbook-community-management/SKILL.md` | Detailed day-to-day moderation playbook, escalation procedures, and community health metrics |
| `platform-whatsapp/SKILL.md` | WhatsApp-specific tactics, broadcast list strategy, and WhatsApp Community setup guidance |
| `platform-facebook/SKILL.md` | Facebook Group optimisation, algorithm considerations, and Facebook Page integration |
| `meta-social-listening/SKILL.md` | Monitoring community sentiment, tracking brand mentions, and identifying emerging issues before they escalate |
