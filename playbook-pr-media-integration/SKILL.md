---
name: playbook-pr-media-integration
description: >
  Generates a PR and earned media integration playbook that bridges social media with traditional
  public relations — covering media pitching, journalist relationship-building, and social
  amplification of press coverage. Invoke this skill when a client wants to pitch a story to
  Ugandan or East African media, amplify existing press coverage through social channels, build
  ongoing relationships with journalists, or develop a coordinated social-PR strategy.
---
